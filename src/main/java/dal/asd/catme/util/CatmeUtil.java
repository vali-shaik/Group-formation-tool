...
public class CatmeUtil {
	...
	public static final String PATH_TO_EMAIL_TEMPLATE = "src/main/java/dal/asd/catme/util/email_template.html";
	public static final String EMAIL_SUBJECT = "Registration of new course in CATME";
}
